...
public class Spawner : MonoBehaviour
{
    ...
    private void BuildTower()
    {
        ...
        {
            currentPoint = BuilSegment(currentPoint, _segmentTemplate.gameObject);
            currentPoint = BuilSegment(currentPoint, _blockTemplate.gameObject);
        }

        BuilSegment(currentPoint, _finishTemplate.gameObject);
    }
    private GameObject BuilSegment(GameObject currentSegment, GameObject nextSegment)
    {
